-- Add missing columns + ensure all tables exist

-- Add source_material to subjects (missing from original 001 migration)
ALTER TABLE subjects ADD COLUMN source_material TEXT;

-- Ensure quiz/lesson tables exist (in case 002 wasn't fully applied)
