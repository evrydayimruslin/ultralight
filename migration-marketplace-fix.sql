-- Hotfix: Update accept_bid to set listing status = 'sold' and block bids on sold listings
-- Run this AFTER migration-marketplace.sql has been applied.

-- 1. Fix accept_bid: set listing status to 'sold' on sale
...
BEGIN
  ...
  -- 8. Update listing provenance, owner, and status
...
-- 2. Fix escrow_bid: block bids on sold listings
