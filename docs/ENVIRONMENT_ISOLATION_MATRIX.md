...
| --- | --- | --- | --- | --- | --- | --- |
| Public API hostname | `https://ultralight-api-staging.rgn4jz429m.workers.dev` | `https://api.ultralightagent.com` | `Isolated` | Platform / API | [api/wrangler.toml](../api/wrangler.toml), [docs/RELEASE_TOPOLOGY.md](RELEASE_TOPOLOGY.md) | Separate Worker scripts and Workers.dev origins; replace only with an owned custom domain |
| Launch website hostname | `https://staging.ultralight-launch-web.pages.dev` | `https://ultralightagent.com` | `Isolated` | Launch Web / Release ops | [apps/launch-web/wrangler.toml](../apps/launch-web/wrangler.toml), [`.github/workflows/launch-web-deploy.yml`](../.github/workflows/launch-web-deploy.yml) | Separate Pages branches and origins; replace only with owned custom domains |
